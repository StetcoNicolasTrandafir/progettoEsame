...
export class SignupPage implements OnInit {
  ...
  constructor(private router: Router, private http: HttpService, private pipe: DatePipe, private notificationService: NotificationsService) { }
          ...
          if (data.code == 50) {
            ...
            this.http.sendPOSTRequest("/user/processUpFile", uploadData).subscribe(
              (result) => {
                ...
                this.notificationService.sendToast('Registrazione effettuata!');
              },
              (error) => {
                console.log(error);
              }
